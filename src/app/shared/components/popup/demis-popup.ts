...
import { Component, ViewContainerRef, TemplateRef, ViewChild, Injectable, Inject, ComponentFactoryResolver, OnDestroy, AfterViewInit, OnInit } from "@angular/core";
...
export class DemisPopup implements OnDestroy, OnInit {
    ...
    @ViewChild('innerPopupContainer', { read: ViewContainerRef }) vcr: ViewContainerRef;
