import { Component, Input, AfterViewInit, ViewChild, Output, EventEmitter, ContentChild, ComponentFactoryResolver, ComponentFactory, Injector, EmbeddedViewRef, ApplicationRef } from '@angular/core';
...
export class DXGridToolbarComponent {

  @ViewChild(DxMenuComponent) menu: DxMenuComponent;
  @ContentChild(DxDataGridComponent) grid: DxDataGridComponent;
  @ContentChild(DXGridToolbarDataSourceComponent) dataSource: DXGridToolbarDataSourceComponent;
