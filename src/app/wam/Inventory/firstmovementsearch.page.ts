...
@Component({
    selector: 'wam-page-firstmovementsearch',
    templateUrl: './firstmovementsearch.page.html',
    providers: [ServiceCaller]
})

export class WAMFirstMovementSearchPage extends BasePage implements OnInit {
    ngOnInit() {
    }
    ...
    onMenuItemClick(name) {
        {
            switch (name) {
                ...
                case "Back": {
                    this.router.navigate(["wam/inventory/firstmovement"]);
                    break;
                }
                ...
                case 'Edit': {
                    ...
                    if (selectedID == null) {
                      ...
                      Notify.error('لطفا گردش موردنظرانتخاب شود');
                        ...
                        this.router.navigate(['wam/inventory/firstmovement'], { queryParams: { ID: selectedID} });
                    }
